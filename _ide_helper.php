...
')
     ...
     */
        ...
        public static function getRequest()
        {
                    ...
                    /**
         * This function binds the CRUD to its corresponding Query (which extends Eloquent).
         *
        ...
        public static function setModel($model_namespace)
        {
                    ...
                    /**
         * Get the corresponding Eloquent Query for the CrudController, as defined with the setModel() function.
         *
        ...
        public static function sync($type, $fields, $attributes)
        {
                    ...
                    /**
         * Get the Eloquent Query name from the given relation definition string.
         *
         ...
         *
         * @param \Illuminate\Database\Eloquent\Model $model Query (eg: user).
         * @param string $relationString Query relation. Can be a string representing the name of a relation method in the given
         *                                  Query or one from a different Query through multiple relations. A dot notation can be used to specify
        ...
        public static function getEntryWithLocale($id)
        {
                    ...
                    /**
         * Return a Query builder instance with the current crud query applied.
         *
        ...
        public static function makeSureFieldHasNecessaryAttributes($field)
        {
                    ...
                    /**
         * Register all Eloquent Query events that are defined on fields.
         *
